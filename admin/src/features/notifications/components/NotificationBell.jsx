...
const TYPE_ACCENT = {
  registration_pending: "bg-primary",
...
const NotificationBell = () => {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {open ? (
        <div className="absolute right-0 z-50 mt-2 w-80 overflow-hidden rounded-xl border border-outline-variant bg-surface shadow-lg">
