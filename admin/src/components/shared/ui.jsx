// Shared admin UI primitives + class constants so list/table pages share one
// look. Colors come from the marketplace theme tokens.
...
export const rowClass = "border-t border-outline-variant hover:bg-surface-container-low";
